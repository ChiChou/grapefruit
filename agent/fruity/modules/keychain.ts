...
const SecItemAdd = new NativeFunction(Security.findExportByName('SecItemAdd')!, 'int', ['pointer', 'pointer'])
const SecItemUpdate = new NativeFunction(Security.findExportByName('SecItemUpdate')!, 'int', ['pointer', 'pointer'])
const SecItemDelete = new NativeFunction(Security.findExportByName('SecItemDelete')!, 'int', ['pointer'])
const SecAccessControlCreateWithFlags = new NativeFunction(Security.findExportByName('SecAccessControlCreateWithFlags')!, 'pointer', ['pointer', 'pointer', 'int', 'pointer'])
